...
public class AI
{
	...
	public static void aiTurn(Characters currentCharacter,
			Characters otherCharacter)
	{
		...
		if (!otherCharacter.getStatus(StatusEnum.BLOCKING)
				...
				&& canKill(currentCharacter.getDamage(),
						otherCharacter.getArmor(), otherCharacter.getHealth()))
		{
		...
		else if (!otherCharacter.getStatus(StatusEnum.BLOCKING)
				&& currentCharacter.getName().equals("Swordsman")
				&& TurnManagement.canSpecial(currentCharacter.getFacing())
				&& currentCharacter.getDistance(
						otherCharacter) <= currentCharacter.getRange()
								+ currentCharacter.getSpeed()
				&& canKill(currentCharacter.getDamage() * 2,
						otherCharacter.getArmor(), otherCharacter.getHealth()))
		{
		...
		else if (currentCharacter.getName().equals("Assasin")
				&& otherCharacter.getStatus(StatusEnum.STUNNED)
				&& currentCharacter.attackHit(otherCharacter.getPosition()))
		{
			currentCharacter.specialAttack(otherCharacter);
		}
		// If enemie == stun, attack
		else if (otherCharacter.getStatus(StatusEnum.STUNNED)
				&& !otherCharacter.getStatus(StatusEnum.BLOCKING)
				&& currentCharacter.attackHit(otherCharacter.getPosition()))
		{
			currentCharacter.attack(otherCharacter);
		...
		{
			moveTo(currentCharacter, otherCharacter,
		...
		else if ((otherCharacter.getName().equals("Assasin")
				|| otherCharacter.getName().equals("Shieldman"))
		...
		// Lanceman special
		else if (currentCharacter.getName().equals("LanceMan")
				&& currentCharacter.getDistance(otherCharacter) <= 20
				&& currentCharacter.getDistance(otherCharacter) > otherCharacter
						.getSpeed())
		{
			currentCharacter.specialAttack(otherCharacter);
		}
		...
		// Archer special
		else if (currentCharacter.getDistance(otherCharacter) <= 3
				&& currentCharacter.getName().equals("Archer")
				&& TurnManagement.canSpecial(currentCharacter.getFacing()))
		{
			currentCharacter.specialAttack(otherCharacter);
		}
		...
		// Alchemist || assasin attack
				...
				&& (currentCharacter.getName().equals("Alchemist")
						|| currentCharacter.getName().equals("Assasin")))
		{
			currentCharacter.attack(otherCharacter);
		}
		// Normal atack
		...
		// Heal
				...
				&& (currentCharacter.getHealth() < currentCharacter
						.getMaxHealth())
				&& (!otherCharacter.attackHit(currentCharacter.getPosition())
						|| (currentCharacter.getHealing() > otherCharacter
								.getDamage())))
		{
			currentCharacter.heals();
		}
		// Block
		else if (currentCharacter.getDistance(otherCharacter) > otherCharacter
				.getSpeed()
				&& otherCharacter.attackHit(currentCharacter.getPosition())
	...
	public static boolean aiPassTrough(Characters currentCharacter, int goal)
	{
		...
		{
			if (Application.obstacle.get(j).passTrough(currentCharacter,
					goal) > 0)
			{
				passTrough = false;
			}
	...
	public static void aiMoveToOpponent(Characters currentCharacter,
			Characters otherCharacter)
	{

		if (currentCharacter.getPosition() > otherCharacter.getPosition())
		{
			if ((otherCharacter.getPosition() + currentCharacter
					.getRange()) >= (currentCharacter.getPosition()
							- currentCharacter.getSpeed()))
			{
				goal = aiStandOn(otherCharacter.getPosition()
						+ currentCharacter.getRange())
								? otherCharacter.getPosition()
										+ currentCharacter.getRange()
								: currentCharacter.getPosition()
										- currentCharacter.getSpeed();
				// goal = otherCharacter.getPosition() +
				// currentCharacter.getRange();
			}
			else
			{
				goal = currentCharacter.getPosition()
						- currentCharacter.getSpeed();
			}

			if (aiStandOn(goal) && (currentCharacter.getPosition()
					- currentCharacter.getSpeed()) == goal)
			{
			...
			{
				currentCharacter
						.moveForward(currentCharacter.getPosition() - goal - 1);
			}
			else if (aiStandOn(currentCharacter.getPosition() - 1))
			{
				...
				while ((aiStandOn(
						currentCharacter.getPosition() - mouvement - 1))
						&& !exitLoop)
				{
				...
				currentCharacter.moveForward(mouvement);
					...
					.validateMouvement(currentCharacter.getPosition()
							- currentCharacter.getSpeed()))
			{
				currentCharacter.jump(0);
			}
		...
		else
		{
			...
			else if (aiPassTrough(currentCharacter, goal))
			{
				currentCharacter.moveBackward(
						goal - currentCharacter.getPosition() - 1);
			}
			else if (aiStandOn(currentCharacter.getPosition() + 1))
			{
				int mouvement = 0;
	...
	public static boolean AIGrab(Characters currentCharacter,
			Characters otherCharacter)
	{
		...
		if (otherCharacter.getStatus(StatusEnum.BLOCKING)
				&& currentCharacter.getDistance(
						otherCharacter) <= currentCharacter.getSpeed()
				&& (Characters.statusObject.get(1)
						.getTurnGotten(currentCharacter
								.getFacing()) == (TurnManagement.getTurn()
										- 1)))
		{
			if (currentCharacter.getDistance(otherCharacter) == currentCharacter
					.getPosition())
			{
				goGrab = true;
			}
			else if (aiPassTrough(currentCharacter,
					otherCharacter.getPosition()))
			{
				goGrab = true;
			}
	...
	public static void moveTo(Characters currentCharacter,
			Characters otherCharacter, int goal)
	{
		if (currentCharacter.getPosition() > otherCharacter.getPosition())
		{
			if (goal == currentCharacter.getPosition()
					- currentCharacter.getSpeed())
			{
				currentCharacter.jump(0);
			}
			...
			{
				currentCharacter
						.moveForward(currentCharacter.getPosition() - goal);
			}
		}
		else
		{
			...
			{
				currentCharacter
						.moveBackward(goal - currentCharacter.getPosition());
			}
		}
	}

	public static void escape(Characters currentCharacter,
			Characters otherCharacter)
	{
		if (currentCharacter.getPosition() > otherCharacter.getPosition())
		{
			if (aiStandOn(currentCharacter.getPosition()
					+ currentCharacter.getSpeed()))
			{
				currentCharacter.jump(1);
			}
			else
			{
				...
				if (currentCharacter.getPosition()
						+ mouvement > otherCharacter.getPosition()
	...
	public static boolean canEscape(Characters currentCharacter,
			Characters otherCharacter)
	{
		boolean canEscape;
		if (currentCharacter.getPosition() > otherCharacter.getPosition())
